...
Baabedo.DEFAULT_HOST = (process.env.BAABEDO_API_URL || 'api.baabedo.com');
Baabedo.DEFAULT_PORT = '443';
Baabedo.DEFAULT_BASE_PATH = '/beta/';
Baabedo.DEFAULT_API_VERSION = null;

// Use node's default timeout:
Baabedo.DEFAULT_TIMEOUT = 120000;
...
var resources = {
  ...
  PaymentPlans: require('./resources/PaymentPlans'),
};
...
Baabedo.prototype = {
  ...
  getClientUserAgent: function(cb) {
    ...
    if (exec) {
      ...
      Baabedo.USER_AGENT.uname = 'BROWSER';
      Baabedo.USER_AGENT_SERIALIZED = JSON.stringify(Baabedo.USER_AGENT);
      cb(Baabedo.USER_AGENT_SERIALIZED);
    }
  },
