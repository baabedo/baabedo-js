  ...
  describe('retrieve', function() {
    ...
    it('Sends the correct request', function() {
      ...
      expect(baabedo.LAST_REQUEST).to.deep.equal({
        method: 'GET',
        url: '/v1/channels/cus_2dkAb792h1mfa4',
        headers: {},
        data: {}
      });
  ...
  describe('Search methods', function() {
    ...
    describe('searchProducts', function() {
      ...
      it('Sends the correct request', function() {
        ...
        expect(baabedo.LAST_REQUEST).to.deep.equal({
          method: 'GET',
          url: '/v1/channels/channelIdFoo321/search/products',
          headers: {},
          data: {}
        });
  ...
  describe('ProductOrders methods', function() {
    ...
    describe('createProductOrders', function() {
      ...
      it('Sends the correct request', function() {
        ...
        expect(baabedo.LAST_REQUEST).to.deep.equal({
          method: 'PUT',
          url: '/v1/channels/channelIdFoo321/product_orders',
          headers: {},
          data: payload
        });
    ...
    describe('updateProductOrder', function() {
      ...
      it('Sends the correct request', function() {
        ...
        expect(baabedo.LAST_REQUEST).to.deep.equal({
          method: 'PUT',
          url: '/v1/channels/channelIdFoo321/product_orders/orderItemIdFoo456',
          headers: {},
          data: payload
        });
  ...
  describe('Statistics methods', function() {
    ...
    describe('retrieveStatisticsProfit', function() {
      ...
      it('Sends the correct request', function() {
        ...
        expect(baabedo.LAST_REQUEST).to.deep.equal({
          method: 'GET',
          url: '/v1/channels/channelIdFoo321/statistics/profit',
          headers: {},
          data: {}
        });
    ...
    describe('retrieveStatisticsRevenue', function() {
      ...
      it('Sends the correct request', function() {
        ...
        expect(baabedo.LAST_REQUEST).to.deep.equal({
          method: 'GET',
          url: '/v1/channels/channelIdFoo321/statistics/revenue',
          headers: {},
          data: {}
        });
  ...
  describe('Product methods', function() {
    ...
    describe('createProduct', function() {
      ...
      it('Sends the correct request', function() {
        ...
        expect(baabedo.LAST_REQUEST).to.deep.equal({
          method: 'POST',
          url: '/v1/channels/channelIdFoo321/products',
          headers: {},
    ...
    describe('retrieveProduct', function() {
      ...
      it('Sends the correct request', function() {
        ...
        expect(baabedo.LAST_REQUEST).to.deep.equal({
          method: 'GET',
          url: '/v1/channels/channelIdFoo321/products/productIdFoo456',
          headers: {},
          data: {}
        });
